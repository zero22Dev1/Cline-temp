...
Skill `html-artifact-checker` を使い、構文、文字化け、見出し、表、長文、印刷、仕様網羅性、Markdown版との一致、ブラウザ表示を確認する。
...
Skill `review-loop` と Skill `loop-verifier` を使い、ビルド、lint、テスト、要件、既存設計、不要変更、例外、ログ、セキュリティ、重複、テスト対応を確認する。
